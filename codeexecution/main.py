...
ROOT_DIRECTORY = Path("D:/ITMO/floodwater-segmentation-net/codeexecution")
SUBMISSION_DIRECTORY = ROOT_DIRECTORY
...
def neural_network_prediction(features_matrix_filtered: np.array,
                              ...
                              features_matrix_julia: np.array,
    ...
    model_1_mask = model_1.predict(features_tensor_julia.cpu())
...
def main():
    ...
    model_1_path = ROOT_DIRECTORY / "assets" / 'julia_net.pth'
